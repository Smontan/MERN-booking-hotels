...
const Search = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5">
      <div className="hidden lg:block rounded-lg border border-slate-300 p-5 h-fit sticky top-10 shadow-md">
      ...
      <div className="flex flex-col gap-5">
        <div className="flex justify-between items-center">
          <span className="text-2xl font-bold">
            Result: {hotelData?.pagination.total} Hotels found{" "}
          ...
          <select
            ...
            className="p-2 border rounded-md shadow-md cursor-pointer "
          >
